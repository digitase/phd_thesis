...
% TODO: review and rewrite all TODOs to make them understandable in the future
% TODO: remove unused graphics from the repo
% TODO: disambiguate terminology: change "response" to "dependent variables", "predictors" to "explanatory variables"
% TODO: harmonize terminology: check upregulation and increased expression are consistent in chapter 4 Results
% TODO: process the notes for pre-post design analysis and basis functions
% TODO: use \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{myfig.png} to scale based on width and height
% TODO: fix incorrect display of compound names with a hyphen in bibliography
% TODO: remove abbreviations not used more than twice
% TODO: deeper spellcheck using a plugin

%
% Preamble
%
\documentclass[english,11pt,a4paper,twoside,openright,final]{book}
%
...
\title{Genomic profiling of response to \textit{in vivo} immune perturbations}
...
%
% Order of frontmatter
% Cambridge requires, in order: title page, original work declaration, abstract
% Mori recommends: title page, dedication, abstract, acknowledgements, toc, lists of figures and tables, list of notation, preface
%
