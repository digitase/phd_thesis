...
% TODO: full read in pdf mode, checking tenses
% TODO: run spellcheck
% TODO: harmonise software name formatting, separate software and texttt
% TODO: skim all chpater TODOs
% TODO: response -> dependent predictors -> Explanatory
% TODO: sub \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{myfig.png}
% TODO: list of figures, shorten to first sentence
% TODO: check upreg and increased expression are consistent in chapter 4
...
% TODO: shorten abstract to 1 page
% TODO: check frontmatter
% TODO: remove unused graphics

% TODO: \texttt is currently used for code. \software should be used for software or R package names?
