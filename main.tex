...
% TODO: for list of figures, shorten to first sentence of the caption only
% TODO: scan reference list typos
% TODO: run spellcheck
% TODO: check hardbound thesis submission requirements
...
% TODO: convert all large numbers to use \num
