...
% TODO: CCC at end of each chapter
% TODO: was done were done
% response -> dependent
% predictors -> Explanatory
% make figures interpretable without reference to text, do not repeat too much data from text to figures
...
% TODO labeling convention hird_eqtl -> reqtl
