\begin{table}[] 
 \centering 
 \caption[\captionshort{Descriptive statistics for \gls{HIRD} individuals with both expression and antibody data.}]{\textbf{Descriptive statistics for \gls{HIRD} individuals with both expression and antibody data.} Values are count and percentage for categorical variables; mean and standard deviation for continuous variables.}\label{tab:hird_table1}
