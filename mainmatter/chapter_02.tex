...
% TODO: microarray to expression array harmonise
...
For example, adults primed by past exposures to seasonal influenza strains have qualitatively different responses to seasonal \gls{LAIV} compared to influenza-naive children, who mount much higher serum antibody responses \autocite{luke2018InfluenzaVaccineLive}. 
...
The \gls{HAI} assay is an inexpensive method for quantifying strain-specific serum anti-\gls{HA} antibody concentrations. 
...
Antibodies induced by \glspl{IIV} are primarily serum IgG antibodies.
...
% NOTE: this is specifically antibody mediated protection, not going into T cells here
...
% T cell responses are also more cross-reactive.
...
For studies of seasonal influenza vaccines in adults, responses are dominated by recall of immunological memory built by past vaccination or infection to antigenically-similar strains \autocite{nakaya2012SystemsVaccinologyLearning,sobolev2016AdjuvantedInfluenzaH1N1Vaccination}.

This is reflected in a to large variability in baseline \autocite{tsang2014GlobalAnalysesHuman}
...
% e.g. pandermix monovalent?


% TODO re read sobolev
...
% TODO: mention TRI alternatives e.g. adjMFC
