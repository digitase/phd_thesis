...
In brief, the study enrolled 178 healthy adult volunteers in the UK\todo{ref demographics table}.
...
\missingfigure{Tables of demographics (potential covariates) by dataset: array and rnaseq, including age, sex, self-reported ethnicity}
...
% https://onlinelibrary.wiley.com/doi/epdf/10.1002/pst.331
...
\subsection{\glsfmtlong{DGE} meta-analysis}
