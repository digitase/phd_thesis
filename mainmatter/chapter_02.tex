...
In the \gls{HIRD} data, I have $k=2$ 'studies' (array and \gls{RNAseq}), where the platform differences described in section\todo{add label} contribute to between-studies heterogeneity, hence a random-effects model is appropriate.
...
\todo{
From \autoref{fig:hird_dgeMeta_priors_tau} and \autoref{fig:hird_dgeMeta_priors_mu}, we are similar.
}
