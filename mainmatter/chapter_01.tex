...
% TODO:
% start with defining genotype, and phenotype
% define molecular phenotypes
% Add biomarkers section to expression as an intermediate trait section
% Change final section title to de emphasise genetics

% TODO:
% section on pathway analyses?
% GSEA paper
...
\todo{can i use published figures?}
...
Genetic association studies have intrinsic resistance to problems like unmeasured confounding and reverse causality, which permeate observational studies of the causes of human phenotypes.
...
% \1 The central dogma represents part of a larger hierarchy by which genetic information is transmitted into whole-organism phenotypes.
...
\1 With increasing sample size, most genes (>60-80\%) have a detectable eQTL \autocite{vandiedonck2017GeneticAssociationMolecular,vosa2018UnravelingPolygenicArchitecture}.
...
\subsection{\Glsfmtlongpl{reQTL} in the immune system}
...
\todo{not sure if right order. Since most reQTL studies are immune, I went context-specific -> reQTL -> immune rather than context-specific -> immune -> reQTL}
    ...
    % TODO: add https://www.nature.com/articles/ni.3371
    ...
    \todo{stable, yet varies by age? respecify scale of stability}
    % TODO: add https://www.sciencedirect.com/science/article/abs/pii/S0952791520300698
...
% TODO: technically vaccines are biologics

\todo{not sure about scope of this subsection, currently some overlap with PANTS chapter intro. tried to separate out only the non-IBD stuff here (mainly intro + RA context)}
