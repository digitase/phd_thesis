...
% \2 These regulatory elements not only have \textit{cis}, but also \textit{trans} regulatory effects on gene expression.
...
\todo{not sure about scope of the subsection, currently some overlap with PANTS chapter intro.}
