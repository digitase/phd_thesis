...
For seasonal influenza vaccine, \textcite{brodin2015VariationHumanImmune} found anti-\gls{HA} antibody responses in 105 adult twin pairs (median age, \SI{44}{\year}) had no detectable heritabilty,
alongside a general decrease in heritability of most immune parameters with age.
They posited that the genetic contribution to response was overshadowed by environmental factors such as previous influenza vaccination or infection in adults, 
in contrast to the substantial heritability of other vaccines mentioned above, many of which are against non-circulating pathogens, or are childhood vaccines for which heritability was assessed in young children.
...
% TODO: add names from linnik2016ImpactHostGenetic
% check replication
% add no gwas
% add gene names
...
%
% TODO
% Cellular response also genetics
...
% 119 and 128 TODO: more detail here, less in intro
% Add CIT here
...
% TODO: the cohort is too small for gWAS, so here expression
