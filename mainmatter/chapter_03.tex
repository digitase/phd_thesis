...
%
% Step 1: why use a change score equivalent, not ANCOVA
...
\todo{does not bias, but unstable and more var of estimates}
...
As suggested by \autocite{stegle2012UsingProbabilisticEstimation}, between-sample normalisation and variance stabilisation \gls{RNAseq} data was performed using \software{DESeq2::vsn}.
...
% this is also the primary motivation behind recommendation of including prognostic covariates in RCTs
