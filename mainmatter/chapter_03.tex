...
% TODO: first thing is to properly re-scaffold everything, including intro and discussion, according to tmp_thesis_plan
% The logical links must be established per paragraph, otherwise moving things around is too frequent
