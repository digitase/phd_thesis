...
Given the modest sample size, I also use the two-step approach used by others\autocite{westra2015CellSpecificEQTL, kim-hellmuth2017GeneticRegulatoryEffects, davenport2018DiscoveringVivoCytokineeQTL} \url{https://doi.org/10.1371/journal.pgen.1005908},
...
% Benjamini-Hochberg procedure, and a 0.15 FDR threshold: https://journals.plos.org/plosgenetics/article?id=10.1371/journal.pgen.1005908#sec007
%
% https://journals.plos.org/plosgenetics/article?id=10.1371/journal.pgen.1005908#sec007
...
\todo{put pve formula in methods}
...
Gene set enrichment analysis on these sets of \glspl{reQTL} at day 1 and day 7 did not detect any significant enrichments (\software{gprofiler2}, g:SCS adjusted p < 0.05).
\todo{mention ranked enrichments}
...
% TODO: get 1 example of reQTL DE at day 1 and day 7, 1 example not.
% make sure filter criteria match above plot
%
% dge no d1 ADCY3
% dge yes d1 LPAR1

% dge no d7 plot_dge_eqtl_genotypes.ENSG00000167670,rs2613791_SNP_chr19_5148372_G_A.pdf
% dge yes d7 plot_dge_eqtl_genotypes.ENSG00000155304,rs9980764_SNP_chr21_14564182_C_T.pdf

- DGE vs reQTL
- fisher test
% TODO: redo fisher test using new criteria

% FRANco comparison like caliskan TODO

% TODO
% plot proving strongest reQTLs are not strongest DGEs

% coloc; which se am i using TODO
