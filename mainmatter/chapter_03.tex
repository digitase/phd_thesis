...
% TODO: not like PCs: not orthogonal
...
otherwise the regression slope of the \gls{eQTL} term will represent an average across the abundance range for that cell type term, and vice versa;
