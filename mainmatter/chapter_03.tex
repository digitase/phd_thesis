...
% TODO: need ASE, not just for validation of the effect, but because eqtl effect size is less than intepretable, and stratified analysis tends to use different adjusted effects per condition.
...
% TODO
% What we have shown is not very interesting
