...
An aim of the \textit{in vivo} \gls{reQTL} design is to find host genetic variants with a causal effect response to some perturbation.
...
\text{In vivo} \gls{reQTL} studies are certainly not ineffectual at their stated goals, 
...
For example, assuming the baseline association of \gene{SIGLEC} with anti-\gls{TNF} response identified in \cref{ch:multiPANTS} is real,
