...
Adjusting for cell abundance in regression only attempts to estimate the effect of other predictors if cell abundance were held constant---it is a change of viewpoint, not data.
It also cannot distinguish cell types with correlated abundance estimates.
