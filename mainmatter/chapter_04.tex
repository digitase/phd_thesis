...
Genewise \gls{DGE} models were fit in \software{dream}\autocite{hoffman2020DreamPowerfulDifferential} in total.
...
% TODO:
% The basis used by ns() is a B-spline basis.
\todo{trying to understand how exactly the B-spline basis for the natural spline works will take a bit more work}
...
\subsubsection{Ranked gene set enrichment}
...
I ranked genes by the signed Z score reported by \software{dream}, which is just a transformation of the \pvalue.
% TODO
...
% FDR
% A data frame with module names, additional statistic (e.g. enrichment or AUC,
% depending on the test), P value and FDR q-value (P value corrected for
% multiple testing using the p.adjust function and Benjamini-Hochberg
% correction.
...
% TODO: gated by lowest n among 4 visits, but 15 to 25 MAF diff only
...
Summary statistics from per-timepoint mapping were input to \software{mashr}.
