...
It remains unclear whether there are any robust single gene associations with anti-\gls{TNF} response.
...
also found increases in type I interferon-regulated gene expression after infliximab treatment associated with poor clinical response \url{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2875639/}.
...
Making use of data from later timepoints allows more subtle effects to be detected in the spline analysis.
...
% TODO:
% am here:
% time, and what we really want is drug level
% MCAR violation
% is binary model most appropriate?
Several threats to the validity of the study remain to be discussed.

    drug level likely to be a mediateor, treated with care like cell counts
...
\1 <conclusion of how the field has moved forward, and future work>
    ...
    % TODO: leveraging RA datasets: shared biology
    ...
    % whilst no causal here, having eqtls for many genes is useful
