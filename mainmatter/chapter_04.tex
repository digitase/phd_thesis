...
I also assessed the previously reported association of \gene{TREM1} expression in blood with anti-\gls{TNF} response.
...
% TODO
% am here: now write paragraph on muddying of whether there is a consensus antiTNF baseline signature
...
a consensus for any marker seems far from established
    ...
    \3 6 main cell types corrected, but doesn't mean that's enough for rare types e.g. see \url{https://www.biorxiv.org/content/10.1101/2020.05.28.120600v1} 
        ...
        % mediation by cell counts suggets cell counts may predict?
...
%     subtle effects detected using interaction and spline analysis: uses more data 
% reQTL
%     not many reQTLs, beware cell type
...
% RA: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2875639/
...
\1 <reQTL>
    ...
    % \2 EE vs EZ model with varying sample size?  https://stephenslab.github.io/mash-application-immune/
