...
\chapter{multiPANTS: transcriptomic associations with anti-\glsfmtshort{TNF} biologic drug response in \glsfmtlong{CD} patients}
...
This chapter focuses on identifying transcriptomic associations with anti-\gls{TNF} primary response 
...
Normalised library sizes were computed using \software{edgeR::calcNormFactors(method='TMM')}.
...
Rank-based gene set enrichment analyses were done using \texttt{tmod::tmodCERNOtest} \autocite{weiner3rd2016TmodPackageGeneral}, 
...
% TODO: explain CERNO to AUC conversion
...
% TODO: add particularly appealing for vaccine studies after moving to ch2
