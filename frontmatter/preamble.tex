...
% provide additional commands e.g. \texteuro; fixes errors like "Command * unavailable in encoding T1."
\usepackage{textcomp}
...
%
% Define percentage formatting
% https://tex.stackexchange.com/questions/468597/convert-decimal-to-percentage-value
\newcommand\percentage[2][round-precision = 1]{% default precision: 2
...
% \usepackage[top=20mm,bottom=20mm,inner=30mm,outer=20mm]{geometry}
% \usepackage[top=20mm,bottom=20mm,inner=30mm,outer=20mm]{geometry}
...
\newabbreviation[]{PNR}{PNR}{primary non-responder}
% \newabbreviation[]{}{}{}
%
