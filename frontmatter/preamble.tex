...
% Provides table of nomenclature
% NOTE: https://texblog.org/2012/05/14/list-of-symbols-or-abbreviations-nomenclature/
% Update (April 2014): This package has not been updated in the past few years.
% You may want to use the more recent and more flexible glossaries package.
% \usepackage{nomencl}
% \makenomenclature

% Glossaries
% NOTE: there are certain packages that must be loaded before glossaries, if they are required: hyperref, babel, polyglossia, inputenc and fontenc.
%    toc: add entry to toc
%    acronym: separate list of acronyms from list of glossary terms
%    nomain: remove default main type glossary
% # NOTE: consider upgrading to glossaries-extra
\usepackage[
    toc,
    acronym,
    nomain,
...
% Set first use of acronym to appear expanded.
\setacronymstyle{long-short}

% Sorting Option 2: sorting using makeindex
% makeglossaries must appear before the glossary entries.
\makeglossaries
