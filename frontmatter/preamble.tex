...
\newabbreviation[longplural=molecular quantitative trait loci]{molQTL}{molQTL}{molecular quantitative trait locus}
...
\newabbreviation[]{ChIPseq}{ChIP-seq}{chromatin immunoprecipitation sequencing}
...
\newabbreviation[]{PANTS}{PANTS}{Personalised Anti-TNF Therapy in Crohn's Disease} % (P)ersonalised (An)ti-(T)NF Therapy in Crohn's di(s)ease
...
\newabbreviation[]{rRNA}{rRNA}{ribosomal RNA}
...
% Format short caption in list of figures i.e. the optional \caption argument
\newcommand{\captionshort}[1]{{#1}}
%
